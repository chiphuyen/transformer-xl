...
class Corpus(object):
    def __init__(self, path, dataset, *args, **kwargs):
        ...
        elif self.dataset in ['wt103', 'ch76']:
        ...
        if self.dataset in ['ptb', 'wt2', 'wt103', 'ch76']:
            ...
            self.train = train_paths
            self.valid = self.vocab.encode_file(
                os.path.join(path, 'valid.txt'), ordered=False, verbose=True, add_double_eos=True)
            self.test  = self.vocab.encode_file(
                os.path.join(path, 'test.txt'), ordered=False, verbose=True, add_double_eos=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='text8',
                        choices=['ptb', 'wt2', 'wt103', 'lm1b', 'enwik8', 'text8', 'ch76', 'libri'],
                        help='dataset name')
